...
const testBulkUpload = async () => {
  ...
  try {
    console.log('🧪 Testing bulk upload with Excel dates and internal invoice numbers...');
    console.log('📊 Test data:', {
      totalInvoices: testInvoices.length,
      sampleInvoice: testInvoices[0]
    });

    const response = await fetch('https://hubpoly-packages.inplsoftwares.online/api/tenant/tenant_1756409312403_uo1hmt4tz/invoices/bulk', {
      method: 'POST',
      headers: {
