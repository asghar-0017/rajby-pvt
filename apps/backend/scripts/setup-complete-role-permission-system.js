...
async function setupCompleteRolePermissionSystem() {
  ...
  try {
    console.log(
      "🚀 Setting up complete role-permission system for production..."
    );
    ...
    const defaultRoles = [
      ...
      },
      {
        ...
        description:
          "Basic user permissions for viewing and limited operations",
        is_system_role: 1,
      },
    ];
    ...
    for (const role of defaultRoles) {
      try {
        ...
        if (existingRole.length > 0) {
          console.log(
            `✓ Role '${role.name}' already exists (ID: ${existingRole[0].id})`
          );
        } else {
          // Create the role
          ...
          console.log(
            `✅ Created role '${role.name}' (ID: ${result.insertId})`
          );
        }
      } catch (error) {
    ...
    const requiredPermissions = [
      ...
      // Buyer Management
      {
        ...
        description: "Create new buyers",
        category: "Buyer Management",
      },
      {
        name: "buyer.view",
        display_name: "Read Buyer",
        description: "View buyer information",
        category: "Buyer Management",
      },
      {
        name: "buyer.update",
        display_name: "Update Buyer",
      ...
      {
        name: "buyer_uploader",
        display_name: "Buyer Uploader",
        description: "Upload buyers",
        category: "Buyer Management",
      },
      ...
      },
      {
        ...
        display_name: "Invoice Uploader",
        description: "Upload invoices",
        category: "Invoice Management",
      },
      {
        name: "invoice_validate",
        display_name: "Invoice Validate",
        description: "Validate invoices",
        category: "Invoice Management",
      },
      {
        name: "invoice_save",
        display_name: "Invoice Save",
      ...
      },
      {
        ...
        description: "Export audit data to CSV",
        category: "Audit Management",
      },
      {
        name: "audit.filter",
        display_name: "Filter Audit Data",
        description: "Filter and search audit data",
        category: "Audit Management",
      },
      {
        name: "audit.summary",
        display_name: "View Audit Summary",
        description: "View audit summary and statistics",
        category: "Audit Management",
      },
    ];
    ...
    for (const permission of requiredPermissions) {
      try {
        ...
        console.error(
          `❌ Error with permission '${permission.name}':`,
          error.message
        );
      }
    }
