  ...
  try {
    ...
    for (const tenant of tenants) {
      ...
      try {
        ...
        console.log(`   ⚠️  Found ${nullSummaries.length} backup summaries with NULL values`);
        ...
        for (const summary of nullSummaries) {
          ...
          if (!summary.fbr_invoice_number && summary.fbr_invoice_number !== null) {
    ...
    console.log('   • Fixed missing invoice numbers, tenant names, and user information');
    console.log('   • Updated backup summary records with proper data');
    console.log('');
    console.log('🔧 Next steps:');
    console.log('   1. The backup system will now properly populate all fields');
