...
async function analyzeAdminUserIndexes() {
  let connection;
  try {
    connection = await createConnection(dbConfig);
    console.log('✅ Connected to database successfully');

    console.log('\n🔍 Analyzing admin_users table indexes...');
    ...
    const [columns] = await connection.execute('SHOW COLUMNS FROM admin_users');
