...
- **Endpoint**: `POST https://tulip-towel.inplsoftwares.online/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://tulip-towel.inplsoftwares.online/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
