...
- **Endpoint**: `POST https://anjum-marketing.inplsoftwares.online/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://anjum-marketing.inplsoftwares.online/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
