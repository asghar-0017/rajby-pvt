...
- **Endpoint**: `POST https://pakistan-gum.inplsoftwares.online/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://pakistan-gum.inplsoftwares.online/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
