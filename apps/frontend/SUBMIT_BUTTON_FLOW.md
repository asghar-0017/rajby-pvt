...
- **Endpoint**: `POST https://paramount-corp.inplsoftwares.online/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://paramount-corp.inplsoftwares.online/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
