...
- **Endpoint**: `POST https://spoltlit.inplsoftwares.online/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://spoltlit.inplsoftwares.online/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
