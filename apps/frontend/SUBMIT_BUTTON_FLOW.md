...
- **Endpoint**: `POST https://siyahimpex.inplsoftwares.com/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://siyahimpex.inplsoftwares.com/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
