...
- **Endpoint**: `POST https://mayanipoly.inplsoftwares.online/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://mayanipoly.inplsoftwares.online/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
