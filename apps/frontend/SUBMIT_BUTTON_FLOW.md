...
- **Endpoint**: `POST https://anjum-chemical.inplsoftwares.online/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://anjum-chemical.inplsoftwares.online/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
