...
- **Endpoint**: `POST https://pakleather.inplsoftwares.online/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://pakleather.inplsoftwares.online/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
