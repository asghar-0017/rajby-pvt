...
- **Endpoint**: `POST https://aja-enterprises.inplsoftwares.online/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://aja-enterprises.inplsoftwares.online/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
