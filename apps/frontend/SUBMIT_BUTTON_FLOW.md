...
- **Endpoint**: `POST http://siyahimpex.inplsoftwares.com/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE http://siyahimpex.inplsoftwares.com/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
