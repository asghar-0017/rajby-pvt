...
async function testCheckExistingBuyers() {
  try {
    ...
    const response = await axios.post(
      `https://paramount-corp.inplsoftwares.online/api/tenant/${tenantId}/buyers/check-existing`,
      { buyers: testBuyers },
      {
        headers: {
...
async function testBuyerUpload() {
  try {
    ...
    const response = await axios.post(
      `https://paramount-corp.inplsoftwares.online/api/tenant/${tenantId}/buyers/bulk`,
      { buyers: testBuyers },
      {
        headers: {
          Authorization: `Bearer ${token}`,
